...
public class GradeBook
{
   ...
   // constructor
   public GradeBook(String courseName, String fileName, Date startDate)
   {
   ...
   public void readData()
   {
	   ...
	   try
	   {
		   while (input.hasNext())
		   {
			   ...
			   //day = input.nextInt();
			   //year = input.nextInt();
			   tempDate = new Date(input.nextInt(), input.nextInt(), input.nextInt());
			 
			   //tempName = input.next();
	    	   //tempGrade = input.nextInt();
			   
			   studentMember.add(new Student(tempName,tempGrade,tempDate));
		   }
	   }
